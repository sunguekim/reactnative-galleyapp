...
const SearchBar = ({ onEndEditing, didTouch, autoFocus, onTextChange, onSubmit }: SearchBarProps) => {
    return (
        <View style={styles.container}>
            <View style={styles.searchBar}>
                <Image style={{ width: 25, height: 25 }} source={require('../images/search.png')} />
                <TextInput
                    style={{ marginLeft: 5, flex: 9, display: 'flex', fontSize: 16, height: 42, justifyContent: 'center', alignSelf: 'center' }}
